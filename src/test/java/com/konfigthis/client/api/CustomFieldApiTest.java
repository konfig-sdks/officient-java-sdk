...
public class CustomFieldApiTest {
     ...
     */
    @Test
    public void editValueForObjectTest() throws ApiException {
        Integer customFieldId = null;
        String objectType = null;
        Integer objectId = null;
        CustomFieldEditValueForObjectResponse response = api.editValueForObject(customFieldId, objectType, objectId)
                .execute();
     ...
     */
    @Test
    public void listFieldsTest() throws ApiException {
        CustomFieldListFieldsResponse response = api.listFields()
                .execute();
        // TODO: test validations
    }
