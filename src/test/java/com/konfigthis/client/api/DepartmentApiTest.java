...
public class DepartmentApiTest {
    ...
    private static DepartmentApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new DepartmentApi(apiClient);
    }
     ...
     */
    @Test
    public void getAllDepartmentsTest() throws ApiException {
        List<DepartmentGetAllDepartmentsResponseInner> response = api.getAllDepartments()
                .execute();
    ...
    public void getDetailTest() throws ApiException {
        ...
        DepartmentGetDetailResponse response = api.getDetail(internalCode)
                .execute();
        // TODO: test validations
    }
