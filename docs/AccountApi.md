...
|------------- | ------------- | -------------|
| [**getInformation**](AccountApi.md#getInformation) | **GET** /1.0/account | Your account |


<a name="getInformation"></a>
# **getInformation**
> AccountGetInformationResponse getInformation().execute();
...
[**AccountGetInformationResponse**](AccountGetInformationResponse.md)
